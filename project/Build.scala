...
//      jsDependencies += "org.webjars.npm" % "react-dom" % "0.14.0" % scope / "react-dom/server.js" commonJSName "ReactDOMServer",
      jsDependencies += "org.webjars.npm" % "react-dom" % "0.14.0" % scope / "server.js" commonJSName "ReactDOMServer",
