...
trait ReactAddonsTestUtils extends js.Object {
   ...
   */
  def mockComponent(c: ReactClass, mockTagName: String = js.native): ReactClass = js.native

  type Mounted = ReactComponent

  /** Returns true if instance is an instance of a React componentClass. */
  def isComponentOfType(instance: ReactElement, c: ReactClass): Boolean = js.native
  ...
  def isCompositeComponentWithType(instance: ReactElement, c: ReactClass): Boolean = js.native
  ...
  def scryRenderedComponentsWithType(tree: Mounted, c: ReactClass): js.Array[Mounted] = js.native
   ...
   */
  def findRenderedComponentWithType(tree: Mounted, c: ReactClass): Mounted = js.native
}
