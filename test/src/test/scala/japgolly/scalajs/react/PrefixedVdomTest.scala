    ...
    'altScalatags {
      ...
      'optional {
        'option {
          ...
          'attr_none    - test(<.div(^.cls := none[String]),   """<div></div>""")
          'style_some   - test(<.div(^.color := "red".some),   """<div style="color:red;"></div>""")
          'style_none   - test(<.div(^.color := none[String]), """<div></div>""")
        ...
        'jsUndefOr {
          ...
          'attr_undef    - test(<.div(^.cls := none[String]),   """<div></div>""")
          'style_def     - test(<.div(^.color := "red".jsdef),  """<div style="color:red;"></div>""")
          'style_undef   - test(<.div(^.color := none[String]), """<div></div>""")
