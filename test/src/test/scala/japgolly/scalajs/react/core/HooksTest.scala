...
object HooksTest extends TestSuite {
  ...
  private def testCustomHookComposition(): Unit = {
    ...
    locally {
      ...
      assertType[(II, LL)](h => h._1 ++ h._2).is[CustomHook[(Int, Long), (Int, Long)]]
      assertType[(II, TF)](h => h._1 ++ h._2).is[CustomHook[(Int, 3), (Int, 4)]]
      assertType[(II, II)](h => h._1 ++ h._2).is[CustomHook[Int, (Int, Int)]]
      assertType[(II, IU)](h => h._1 ++ h._2).is[CustomHook[Int, Int]]
      assertType[(II, UI)](h => h._1 ++ h._2).is[CustomHook[Int, (Int, Int)]]
      assertType[(II, UU)](h => h._1 ++ h._2).is[CustomHook[Int, Int]]

      assertType[(IU, LL)](h => h._1 ++ h._2).is[CustomHook[(Int, Long), Long]]
      assertType[(IU, TF)](h => h._1 ++ h._2).is[CustomHook[(Int, 3), 4]]
      assertType[(IU, II)](h => h._1 ++ h._2).is[CustomHook[Int, Int]]
      assertType[(IU, IU)](h => h._1 ++ h._2).is[CustomHook[Int, Unit]]
      assertType[(IU, UI)](h => h._1 ++ h._2).is[CustomHook[Int, Int]]
      assertType[(IU, UU)](h => h._1 ++ h._2).is[CustomHook[Int, Unit]]

      assertType[(UI, LL)](h => h._1 ++ h._2).is[CustomHook[Long, (Int, Long)]]
      assertType[(UI, TF)](h => h._1 ++ h._2).is[CustomHook[3, (Int, 4)]]
      assertType[(UI, II)](h => h._1 ++ h._2).is[CustomHook[Int, (Int, Int)]]
      assertType[(UI, IU)](h => h._1 ++ h._2).is[CustomHook[Int, Int]]
      assertType[(UI, UI)](h => h._1 ++ h._2).is[CustomHook[Unit, (Int, Int)]]
      assertType[(UI, UU)](h => h._1 ++ h._2).is[CustomHook[Unit, Int]]

      assertType[(UU, LL)](h => h._1 ++ h._2).is[CustomHook[Long, Long]]
      assertType[(UU, TF)](h => h._1 ++ h._2).is[CustomHook[3, 4]]
      assertType[(UU, II)](h => h._1 ++ h._2).is[CustomHook[Int, Int]]
      assertType[(UU, IU)](h => h._1 ++ h._2).is[CustomHook[Int, Unit]]
      assertType[(UU, UI)](h => h._1 ++ h._2).is[CustomHook[Unit, Int]]
      assertType[(UU, UU)](h => h._1 ++ h._2).is[CustomHook[Unit, Unit]]

      assertType[(LL, LL)](h => h._1 ++ h._2).is[CustomHook[Long, (Long, Long)]]
      assertType[(LL, II)](h => h._1 ++ h._2).is[CustomHook[(Long, Int), (Long, Int)]]
      assertType[(LL, IU)](h => h._1 ++ h._2).is[CustomHook[(Long, Int), Long]]
      assertType[(LL, UI)](h => h._1 ++ h._2).is[CustomHook[Long, (Long, Int)]]
      assertType[(LL, UU)](h => h._1 ++ h._2).is[CustomHook[Long, Long]]

      assertType[(TF, FT)](h => h._1 ++ h._2).is[CustomHook[(3, 4), (4, 3)]]
      assertType[(TF, II)](h => h._1 ++ h._2).is[CustomHook[(3, Int), (4, Int)]]
      assertType[(TF, IU)](h => h._1 ++ h._2).is[CustomHook[(3, Int), 4]]
      assertType[(TF, LL)](h => h._1 ++ h._2).is[CustomHook[(3, Long), (4, Long)]]
      assertType[(TF, TF)](h => h._1 ++ h._2).is[CustomHook[3, 4]]
      assertType[(TF, UI)](h => h._1 ++ h._2).is[CustomHook[3, (4, Int)]]
      assertType[(TF, UU)](h => h._1 ++ h._2).is[CustomHook[3, 4]]

      assertType[(FT, FT)](h => h._1 ++ h._2).is[CustomHook[4, 3]]
      assertType[(FT, II)](h => h._1 ++ h._2).is[CustomHook[(4, Int), (3, Int)]]
      assertType[(FT, IU)](h => h._1 ++ h._2).is[CustomHook[(4, Int), 3]]
      assertType[(FT, LL)](h => h._1 ++ h._2).is[CustomHook[(4, Long), (3, Long)]]
      assertType[(FT, TF)](h => h._1 ++ h._2).is[CustomHook[(4, 3), (3, 4)]]
      assertType[(FT, UI)](h => h._1 ++ h._2).is[CustomHook[4, (3, Int)]]
      assertType[(FT, UU)](h => h._1 ++ h._2).is[CustomHook[4, 3]]
    }
