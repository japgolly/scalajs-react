...
object HookCtxFn {
  ...
  sealed trait PC1[P, H1] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1) => A }
  sealed trait PC2[P, H1, H2] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2) => A }
  sealed trait PC3[P, H1, H2, H3] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3) => A }
  sealed trait PC4[P, H1, H2, H3, H4] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4) => A }
  sealed trait PC5[P, H1, H2, H3, H4, H5] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5) => A }
  sealed trait PC6[P, H1, H2, H3, H4, H5, H6] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6) => A }
  sealed trait PC7[P, H1, H2, H3, H4, H5, H6, H7] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7) => A }
  sealed trait PC8[P, H1, H2, H3, H4, H5, H6, H7, H8] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8) => A }
  sealed trait PC9[P, H1, H2, H3, H4, H5, H6, H7, H8, H9] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9) => A }
  sealed trait PC10[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10) => A }
  sealed trait PC11[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11) => A }
  sealed trait PC12[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12) => A }
  sealed trait PC13[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13) => A }
  sealed trait PC14[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14) => A }
  sealed trait PC15[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15) => A }
  sealed trait PC16[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16) => A }
  sealed trait PC17[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17) => A }
  sealed trait PC18[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18) => A }
  sealed trait PC19[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19) => A }
  sealed trait PC20[P, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19, H20] extends HookCtxFn { override type Fn[A] = (P, PropsChildren, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19, H20) => A }
}
