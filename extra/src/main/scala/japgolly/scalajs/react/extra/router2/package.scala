...
package object router2 {
  ...
  implicit final class ReactRouteProgExt[P, A](private val _a: RouteProg[A]) extends AnyVal {
    def >>[B](b: RouteProg[B]): RouteProg[B] = _a flatMap (_ => b)
  }

  implicit final class ReactRouteCmdExt[P, A](private val _a: RouteCmd[A]) extends AnyVal {
