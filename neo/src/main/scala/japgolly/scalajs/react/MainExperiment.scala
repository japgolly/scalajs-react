...
object MainExperiment {
  ...
  // TODO Constrain P0 to subtypes of js.Object

  sealed trait JsC0[P, U, P0, U0] extends GenC0[P, U, P0, U0] {
    override def mapP[X](f: X => P): JsC0[X, U, P0, U0]
    override def mapU[X](f: U => X): JsC0[P, X, P0, U0]
  }

  sealed trait JsU0[P, M, P0, M0] extends GenU0[P, M, P0, M0] {
  ...
  sealed trait JsM0[P, R <: RawReactComponent, P0] extends GenM0[P, P0] {
    override def mapP[X](f: P => X): JsM0[X, R, P0]
    val raw: R
    def addRawType[T] = this.asInstanceOf[JsM0[P, R with T, P0]]
  }

  type JsUnmappedC[P, U] = JsC0[P, U, P, U]
  type JsUnmappedU[P, M] = JsU0[P, M, P, M]
  type JsUnmappedM[P, R <: RawReactComponent] = JsM0[P, R, P]

  type JsC[P, R <: RawReactComponent] = JsUnmappedC[P, JsU[P, R]]
  type JsU[P, R <: RawReactComponent] = JsUnmappedU[P, JsM[P, R]]
  type JsM[P, R <: RawReactComponent] = JsUnmappedM[P, R]

  private def mapJsC[P2, U2, P1, U1, P0, U0](from: JsC0[P1, U1, P0, U0])(cp: P2 => P1, mu: U1 => U2): JsC0[P2, U2, P0, U0] =
  ...
  private def mapJsU[P2, M2, P1, M1, P0, M0](from: JsU0[P1, M1, P0, M0])(mp: P1 => P2, mm: M1 => M2): JsU0[P2, M2, P0, M0] =
  ...
  private def mapJsM[P2, R <: RawReactComponent, P1, P0](from: JsM0[P1, R, P0])(mp: P1 => P2): JsM0[P2, R, P0] =
    new JsM0[P2, R, P0] {
  ...
  def jsComponent[P](name: String): JsC[P, RawReactComponent] = {
    type R = RawReactComponent

    def jsC(rawC: js.Dynamic): JsC[P, R] =
      new JsC[P, R] {
        def apply(p: P)                = jsU(rawC(p.asInstanceOf[js.Object]))
