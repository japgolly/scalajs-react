...
object Js extends TemplateForJsBaseComponent[Raw.ReactClass] {
  ...
  // Root~       = Shallow. 0s match 1s. {P,S,CT} unmapped {F,R} possibly mapped.
  // ~           = Deep. when you first create a component before any mapping or addRawType
  // ~PlusFacade = Deep. ~ with raw type
  // Mapped~     = Deep.

  type RawMounted = Raw.ReactComponent

  type RootUnmounted[P <: js.Object, M] =
    BaseUnmounted[P, M, P, M]

  type RootMounted[F[+_], P <: js.Object, S <: js.Object, R <: RawMounted] =
    BaseMounted[F, P, S, R, P, S]
  ...
  type ComponentWithRawType[P <: js.Object, S <: js.Object, CT[-p, +u] <: CtorType[p, u], R <: RawMounted] =
    RootComponent[P, CT, UnmountedWithRawType[P, S, R]]

  type UnmountedWithRawType[P <: js.Object, S <: js.Object, R <: RawMounted] =
    RootUnmounted[P, MountedWithRawType[P, S, R]]

  type MountedWithRawType[P <: js.Object, S <: js.Object, R <: RawMounted] =
    RootMounted[Effect.Id, P, S, R]

  type ComponentPlusFacade[P <: js.Object, S <: js.Object, CT[-p, +u] <: CtorType[p, u], R <: js.Object] =
    ComponentWithRawType[P, S, CT, RawMounted with R]

  type UnmountedPlusFacade[P <: js.Object, S <: js.Object, R <: js.Object] =
    UnmountedWithRawType[P, S, RawMounted with R]

  type MountedPlusFacade[P <: js.Object, S <: js.Object, R <: js.Object] =
    MountedWithRawType[P, S, RawMounted with R]

  // ===================================================================================================================

  type MappedMounted  [F[+_], P1, S1, R <: RawMounted, P0 <: js.Object, S0 <: js.Object] = BaseMounted[F, P1, S1, R, P0, S0]
  type MappedUnmounted[F[+_], P1, S1, R <: RawMounted, P0 <: js.Object, S0 <: js.Object] = BaseUnmounted[P1, MappedMounted[F, P1, S1, R, P0, S0], P0, MountedWithRawType[P0, S0, R]]
  type MappedComponent[F[+_], P1, S1, R <: RawMounted, P0 <: js.Object, S0 <: js.Object, CT1[-p, +u] <: CtorType[p, u], CT0[-p, +u] <: CtorType[p, u]] = BaseComponent[P1, CT1, MappedUnmounted[F, P1, S1, R, P0, S0], P0, CT0, UnmountedWithRawType[P0, S0, R]]
