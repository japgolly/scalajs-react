...
object MonocleOptionalModifier {
  ...
  implicit object LensM extends MonocleOptionalModifier[PLens] {
    @inline final override def modifyOption[S, T, A, B](l: PLens[S, T, A, B])(f: A => Option[B]) = l.modifyA(f)
  }
  implicit object OptionalM extends MonocleOptionalModifier[POptional] {
    @inline final override def modifyOption[S, T, A, B](l: POptional[S, T, A, B])(f: A => Option[B]) = l.modifyA(f)
  }
  implicit object IsoM extends MonocleOptionalModifier[PIso] {
    @inline final override def modifyOption[S, T, A, B](l: PIso[S, T, A, B])(f: A => Option[B]) = l.modifyA(f)
  }
  implicit object PrismM extends MonocleOptionalModifier[PPrism] {
    @inline final override def modifyOption[S, T, A, B](l: PPrism[S, T, A, B])(f: A => Option[B]) = l.modifyA(f)
  }
  implicit object TraversalM extends MonocleOptionalModifier[PTraversal] {
    @inline final override def modifyOption[S, T, A, B](l: PTraversal[S, T, A, B])(f: A => Option[B]) = l.modifyA(f)
  }
}
