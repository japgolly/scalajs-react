function $c_Lsjr_test_emissions_UseState$() {
  ...
  var f = new $j_AnonFunction2.$c_sjsr_AnonFunction2((x$1$2, s$2) => {
    ...
    $j_sjr_vdom_html_$.$m_Lsjr_vdom_html＿$();
    ...
    $j_sjr_vdom_VdomNode$.$m_Lsjr_vdom_VdomNode$();
    var array = [$$x1, new $j_sjr_vdom_VdomNode$$anon$1.$c_Lsjr_vdom_VdomNode$$anon$1(v), $j_sjr_vdom_html_$.$m_Lsjr_vdom_html＿$().Lsjr_vdom_html＿$__f_$up.Lsjr_vdom_HtmlAttrAndStyles$__f_onClick.$minus$minus$greater__F0__F1__Lsjr_vdom_TagMod(new $j_AnonFunction0.$c_sjsr_AnonFunction0((s$1 => () => {
  ...
  var step$1 = new $j_sjr_hooks_ComponentP_SubsequentSteps$$anon$1.$c_Lsjr_hooks_ComponentP＿SubsequentSteps$$anon$1(this$17);
