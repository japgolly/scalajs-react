...
object MonocleExtStateSnapshot {
  ...
  final class WithLens[S, A](private val lens: Lens[S, A]) extends AnyVal {
    ...
    def of[I](i: I)(implicit t: StateAccessor.ReadIdWriteCB[I, S]): StateSnapshot[A] =
  ...
  final class WithLensReuse[S, A](private val lens: Lens[S, A]) extends AnyVal {
    ...
    def of[I](i: I)(implicit t: StateAccessor.ReadIdWriteCB[I, S], r: Reusability[A]): StateSnapshot[A] =
      apply(t.state(i)).writeVia(i)
  }
  ...
  final class WithLensValue[S, A](private val lens: Lens[S, A], value: S) {
    ...
    def writeVia[I](i: I)(implicit t: StateAccessor.WriteCB[I, S]): StateSnapshot[A] =
      apply(t.modState(i))
  }
  ...
  final class WithLensReuseValue[S, A](private val lens: Lens[S, A], value: S) {
    ...
    def writeVia[I](i: I)(implicit t: StateAccessor.WriteCB[I, S], r: Reusability[A]): StateSnapshot[A] =
      apply(t.modState(i))
  }
}
