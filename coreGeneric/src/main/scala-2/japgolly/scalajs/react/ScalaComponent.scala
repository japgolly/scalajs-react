...
object ScalaComponent {
  ...
  type Mounted        [F[_], A[_], P, S, B]                 = Scala.Mounted[F, A, P, S, B]
  type MountedImpure  [P, S, B]                             = Scala.MountedImpure[P, S, B]
  type MountedPure    [P, S, B]                             = Scala.MountedPure[P, S, B]
  type MountedRoot    [F[_], A[_], P, S, B]                 = Scala.MountedRoot[F, A, P, S, B]
  type MountedSimple  [F[_], A[_], P, S, B]                 = Scala.MountedSimple[F, A, P, S, B]
  type MountedWithRoot[F[_], A[_], P1, S1, B, P0, S0]       = Scala.MountedWithRoot[F, A, P1, S1, B, P0, S0]
